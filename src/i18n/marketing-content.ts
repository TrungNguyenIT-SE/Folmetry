...
export const marketingEn = {
  ...
  privacy: {
    sections: [
      section("ai-assistant", "AI assistant and external providers", ["When you use Folmetry Assistant, your message and a bounded amount of conversation history are sent through Folmetry's server to the selected AI provider: Groq or Cloudflare Workers AI. Conversations are stored under your authenticated Folmetry account so they are available across your devices."], ["Relationship ZIP files, raw exports, and synchronized relationship lists are never attached automatically.", "Provider processing and retention are governed by the provider's current terms and privacy policy.", "Live Web remains unavailable until a separately reviewed search provider is configured.", "Deleting a conversation in the assistant removes that conversation from Folmetry storage.", "Do not submit passwords, access tokens, identity documents, or highly sensitive personal data."]),
  ...
  terms: {
    sections: [
      section("ai-assistant", "AI answers require judgment", ["Folmetry Assistant may produce incomplete, outdated, or incorrect answers. It is not a substitute for a qualified professional, and you remain responsible for decisions made from its output."], ["Do not rely on it alone for medical, legal, financial, safety-critical, or emergency decisions.", "Live Web citations are third-party links; Folmetry does not endorse or control their content.", "Do not use the assistant to violate law, platform rules, intellectual-property rights, privacy, or another person's safety."]),
  ...
  faq: {
    ...
    items: [
      { question: "What does the AI assistant receive and store?", answer: "It receives the message you submit and a bounded portion of that conversation. Folmetry stores assistant conversations under your signed-in account for cross-device history. It never automatically receives relationship ZIP files, raw exports, or synchronized follower lists. You can delete a conversation from the assistant." },
...
export const marketingVi = {
  ...
  privacy: {
    sections: [
      section("ai-assistant", "Trợ lý AI và nhà cung cấp bên ngoài", ["Khi bạn dùng Trợ lý Folmetry, nội dung bạn gửi cùng một phần lịch sử hội thoại có giới hạn được chuyển qua máy chủ Folmetry đến nhà cung cấp AI được chọn là Groq hoặc Cloudflare Workers AI. Hội thoại được lưu theo tài khoản Folmetry đã đăng nhập để có thể dùng trên nhiều thiết bị."], ["ZIP quan hệ, bản xuất thô và danh sách quan hệ đã đồng bộ không bao giờ được tự động đính kèm.", "Việc xử lý và lưu giữ tại nhà cung cấp tuân theo điều khoản và chính sách quyền riêng tư hiện hành của họ.", "Chế độ Web trực tiếp chưa khả dụng cho đến khi một nhà cung cấp tìm kiếm riêng được rà soát và cấu hình.", "Xóa hội thoại trong trợ lý sẽ xóa hội thoại đó khỏi kho lưu trữ Folmetry.", "Không gửi mật khẩu, access token, giấy tờ định danh hoặc dữ liệu cá nhân đặc biệt nhạy cảm."]),
  ...
  terms: {
    sections: [
      section("ai-assistant", "Câu trả lời AI cần được kiểm chứng", ["Trợ lý Folmetry có thể đưa ra câu trả lời thiếu, lỗi thời hoặc không chính xác. Đây không phải là sự thay thế cho chuyên gia đủ năng lực; bạn chịu trách nhiệm với quyết định dựa trên nội dung AI."], ["Không chỉ dựa vào AI cho quyết định y tế, pháp lý, tài chính, an toàn trọng yếu hoặc tình huống khẩn cấp.", "Trích dẫn Web trực tiếp là liên kết của bên thứ ba; Folmetry không bảo chứng hoặc kiểm soát nội dung đó.", "Không dùng trợ lý để vi phạm pháp luật, quy định nền tảng, quyền sở hữu trí tuệ, quyền riêng tư hoặc sự an toàn của người khác."]),
  ...
  faq: {
    ...
    items: [
      { question: "Trợ lý AI nhận và lưu dữ liệu nào?", answer: "Trợ lý nhận nội dung bạn gửi và một phần có giới hạn của hội thoại đó. Folmetry lưu hội thoại theo tài khoản đang đăng nhập để đồng bộ lịch sử giữa các thiết bị. Trợ lý không tự động nhận ZIP quan hệ, bản xuất thô hoặc danh sách follower đã đồng bộ. Bạn có thể xóa hội thoại ngay trong trợ lý." },
