...
export const marketingEn = {
  ...
  privacy: {
    sections: [
      section("ai-assistant", "AI assistant and external providers", ["When you use Folmetry Assistant, your message and a bounded amount of conversation history are sent through Folmetry's server to the selected AI provider: Groq or Google. Conversations are stored under your authenticated Folmetry account so they are available across your devices."], ["Relationship ZIP files, raw exports, and synchronized relationship lists are never attached automatically.", "Provider processing and retention are governed by the provider's current terms and privacy policy.", "Live Web mode may use Google Search grounding and return links to external sources.", "Deleting a conversation in the assistant removes that conversation from Folmetry storage.", "Do not submit passwords, access tokens, identity documents, or highly sensitive personal data."]),
...
export const marketingVi = {
  ...
  privacy: {
    sections: [
      section("ai-assistant", "Trợ lý AI và nhà cung cấp bên ngoài", ["Khi bạn dùng Trợ lý Folmetry, nội dung bạn gửi cùng một phần lịch sử hội thoại có giới hạn được chuyển qua máy chủ Folmetry đến nhà cung cấp AI được chọn là Groq hoặc Google. Hội thoại được lưu theo tài khoản Folmetry đã đăng nhập để có thể dùng trên nhiều thiết bị."], ["ZIP quan hệ, bản xuất thô và danh sách quan hệ đã đồng bộ không bao giờ được tự động đính kèm.", "Việc xử lý và lưu giữ tại nhà cung cấp tuân theo điều khoản và chính sách quyền riêng tư hiện hành của họ.", "Chế độ Web trực tiếp có thể dùng Google Search grounding và trả về liên kết nguồn bên ngoài.", "Xóa hội thoại trong trợ lý sẽ xóa hội thoại đó khỏi kho lưu trữ Folmetry.", "Không gửi mật khẩu, access token, giấy tờ định danh hoặc dữ liệu cá nhân đặc biệt nhạy cảm."]),
